...
gulp.task('dist', ['lint', 'test'], function() {
	...
	var application_file_paths = ['peach', 'peach.drawable', 'peach.input', 'peach.geometry', 'peach.geometry.point', 'peach.geometry.rectangle', 'peach.primitive'].map(function(file) {
		return 'src/' + file + '.js';
	});
